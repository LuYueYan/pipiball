...
var rankModal = (function (_super) {
    ...
    rankModal.prototype.getWorld = function () {
        ...
        ServiceMaster.post(ServiceMaster.rank_world, params, function (res) {
            if (res.code == 1 && res.data) {
                ...
                that.myRank.text = '您当前为：第' + res.data.rank_user.rank + '名';
    ...
    rankModal.prototype.friendFun = function () {
        ...
        this.friend.texture = RES.getRes('btn_tittle_a1_png');
        this.world.texture = RES.getRes('btn_tittle_b2_png');
    ...
    rankModal.prototype.worldFun = function () {
        ...
        this.friend.texture = RES.getRes('btn_tittle_a2_png');
        this.world.texture = RES.getRes('btn_tittle_b1_png');
